...
DATA_SET_PATH = "F:\Research\IEEE SS12\Malaria_data.csv" #put your file path dude!
...
color = 'tab:blue'
ax2.set_ylabel('Malarial cases', color=color)  # we already handled the x-label with axis machan
